...
/*у 4 та 5 прикладі правильно виводить найбільше та найменше число серед чотирьох введених, але, 
 якщо ввести два або три однакові
 числа, то висвітить і найменше/найбільше, і що значення рівні. 
 Баг, бачу його, але не встигну виправити до заняття*/


//Останню задачу робив максимально просто, без перевірок правильності введення тексту і т. д., аби лиш працювало...
